...
public struct AboutMe {
    const name = "Mohamed Mahmoud"
    const pronouns = ["he","him"]
    
    let profession = "Software Developer & Web Designer"
    
    let preferredTechStack = ["Typescript", "React", "Redux", "PostgreSQL", "Node", ...]
    Let hasUsed = ["Next", "Nuxt", "C#"]
}
```
